...
class RepositorioFornecedorEmBDR implements RepositorioFornecedor{
    ...
    public function todos(string $filtro = ''){
        ...
        try{
            ...
            throw new RepositoryException('Erro ao buscar fornecedor', $e->jetCode(), $e);
        }
    }
    ...
    public function cadastrar (Fornecedor & $fornecedor){
        try{
            ...
            throw new RepositoryException('Erro ao cadastrar fornecedor', $e->jetCode(), $e);
        }
    }
    ...
    public function atualizar (Fornecedor $fornecedor){
        try{
            ...
            throw new RepositoryException('Erro ao atualizar fornecedor', $e->jetCode(), $e);
        }
    }
    ...
    public function remover (string $idOuCodigo){
        try{
            ...
            throw new RepositoryException('Erro ao deletar fornecedor', $e->jetCode(), $e);
        }
    }
